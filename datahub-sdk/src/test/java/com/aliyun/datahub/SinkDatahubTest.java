 ...
 */
public class SinkDatahubTest {
    private String fromTopic;
    private String toTopic;
    private String project = DatahubTestUtils.getProjectName();
    private DatahubClient client = DatahubTestUtils.getDefaultClient();
    ...
    public void testSinkDatahub() throws InterruptedException {
        ...
        client.createDataConnector(project, fromTopic, ConnectorType.SINK_DATAHUB, columns, config);
